...
Join   https://www.facebook.com/profile.php?id=100078790456309
'''
#!/usr/bin/python3
...
emad=[]
os.system("https://www.facebook.com/profile.php?id=100078790456309")
def mail(emad, limit):
    while True:
...
def file_subb(Gmail,psslist):
    global oks,done
    sys.stdout.write(f"\r  \033[38;5;46m[LABIB-XD] {done}|{str(len(oks))}\r");sys.stdout.flush()
